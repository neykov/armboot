 ...
 */
pub struct NVICType {
    pub ISER: [u32, ..1],                 /*< Offset: 0x000 (R/W)  Interrupt Set Enable Register           */
    pub RESERVED0: [u32, ..31],
    pub ICER: [u32, ..1],                 /*< Offset: 0x080 (R/W)  Interrupt Clear Enable Register          */
    pub RSERVED1: [u32, ..31],
    pub ISPR: [u32, ..1],                 /*< Offset: 0x100 (R/W)  Interrupt Set Pending Register           */
    pub RESERVED2: [u32, ..31],
    pub ICPR: [u32, ..1],                 /*< Offset: 0x180 (R/W)  Interrupt Clear Pending Register         */
    pub RESERVED3: [u32, ..31],
    pub RESERVED4: [u32, ..64],
    pub IP: [u32, ..8]                   /*< Offset: 0x300 (R/W)  Interrupt Priority Register              */
}
